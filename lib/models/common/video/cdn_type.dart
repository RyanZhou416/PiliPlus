...
enum CDNService {
  ...
  bos('bos（百度云）', 'upos-sz-mirrorbos.bilivideo.com'),
  ...
  coso2('coso2（腾讯云）', 'upos-sz-mirrorcoso2.bilivideo.com'),
  ...
  ks3('ks3（金山云）', 'upos-sz-mirrorks3.bilivideo.com'),
  ks3b('ks3b（金山云）', 'upos-sz-mirrorks3b.bilivideo.com'),
  ks3c('ks3c（金山云）', 'upos-sz-mirrorks3c.bilivideo.com'),
  kodo('kodo（七牛云）', 'upos-sz-mirrorkodo.bilivideo.com'),
  kodob('kodob（七牛云）', 'upos-sz-mirrorkodob.bilivideo.com'),
  upcdnbda2('upcdnbda2（UPCDN加速）', 'upos-sz-upcdnbda2.bilivideo.com'),
  upcdnws('upcdnws（UPCDN加速）', 'upos-sz-upcdnws.bilivideo.com'),
  tf_hw('tf_hw（华为云）', 'upos-tf-all-hw.bilivideo.com'),
  tf_tx('tf_tx（腾讯云）', 'upos-tf-all-tx.bilivideo.com'),
  akamai('akamai-hz（Akamai海外）', 'upos-hz-mirrorakam.akamaized.net'),
  akamai_sz('akamai-sz（Akamai海外）', 'upos-sz-mirrorakam.akamaized.net'),
